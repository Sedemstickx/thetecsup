...
{  
    ...
    public function send_bulk_mails($subject,$message,$from="<mail@thetecsup.com>")
    {
      global $db;
      global $site_title;
      ...
      ///Use the default php mail function to send mails. 
      $from_with_name = $site_title . $from;
      ...
      //mail function should contain(to,subject,message,headers).  
      $result = mail($emails['email'],$subject,$message,$headers);
